...
window.MathJax = {
  ...
  //
  jax: ['input/TeX', 'input/MathML', 'output/HTML-CSS'], // XXX jax: ["input/TeX"]
  ...
  //
  extensions: [ // XXX extensions: ["tex2jax.js"]
    'tex2jax.js',
    'mml2jax.js',
    'asciimath2jax.js',
    'MathMenu.js',
  ...
  'HTML-CSS': {
    ...
    linebreaks: {
      ...
      //
      automatic: true, // XXX automatic:false
